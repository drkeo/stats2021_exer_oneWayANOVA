...
\##`{r} cannot run code due to error jmv::ANOVA(     formula = Happiness ~ Dose,     data = dataset,     effectSize = c("partEta", "omega"),     homo = TRUE,     norm = TRUE,     qq = TRUE,     postHoc = ~ Dose,     postHocCorr = C("turkey", "holm"),     postHocES = "d")`
